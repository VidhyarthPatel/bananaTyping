    ...
    <nav className="flex items-center justify-between py-2 border-b border-[#222222]/80 select-none">
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3.5 text-[#444444] mt-0.5">
          {/* Info Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4.5 h-4.5 hover:text-[#dddddd] transition-colors cursor-pointer" title="Info">
          ...
          {/* Keyboard Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4.5 h-4.5 hover:text-[#dddddd] transition-colors cursor-pointer text-[#e2b714]" title="Typing Test">
          ...
          {/* Leaderboard Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4.5 h-4.5 hover:text-[#dddddd] transition-colors cursor-pointer" title="Leaderboard">
          ...
          {/* Settings Icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4.5 h-4.5 hover:text-[#dddddd] transition-colors cursor-pointer" title="Settings">
