    ...
    <nav className="flex items-center justify-between py-2 border-b border-[#222222]/80 select-none">
      <div className="flex items-center gap-2.5 sm:gap-4 md:gap-5">
        <span
          ...
          className="text-lg sm:text-xl md:text-2xl font-bold font-mono tracking-wide text-[#e2b714] cursor-pointer hover:opacity-85 transition-opacity"
        >
          BananaTyping
        </span>
        
        {/* Navigation utility icons */}
        <div className="flex items-center gap-2 sm:gap-3.5 text-[#444444] mt-0.5">
          {/* Info Icon */}
          ...
          <svg
            ...
            strokeWidth={2.5}
            stroke="currentColor"
            className="w-4.5 h-4.5 hover:text-[#dddddd] transition-colors cursor-pointer"
          >
      ...
      <div>
        <a
          ...
          className="bg-[#e2b714] text-[#000000] text-xs font-mono font-bold px-2 py-1.5 sm:px-3 sm:py-1.5 rounded hover:bg-[#f5c928] transition-colors duration-200 flex items-center gap-1.5 shadow-md"
        >
